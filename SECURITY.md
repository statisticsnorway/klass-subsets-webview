...
repositories, please report it to us using the [Github Private vulnerability reporting tool](https://github.com/statisticsnorway/klass-subsets-webview/security/advisories).